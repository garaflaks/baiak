dofile('data/lib/rewardchest.lua')

local function addRewardLoot(uid, bossName, tabela_reward)
	local money = math.random(10, 40)
	local msg = "[REWARD SYSTEM] Uma parcel foi enviada para o seu DEPOT  com os seguintes itens:"
	local chest = doCreateItemEx(REWARDCHEST.rewardBagId)

	doItemSetAttribute(chest, "descrição", "Reward System matou o boss ".. bossName ..".")
