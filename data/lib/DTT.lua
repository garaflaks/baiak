...
dtt = {
    pos = {
        temple_wait = {x=122, y=321, z=7}, -- sala de espera
        tp_create = {x=165, y=42, z=7}, -- onde teleport de entrada sera criado
    },
	...
	reward_items = {6571, 1}, {12701, 1}, {12694, 1}, --Modelo: {ID, QUANTIA}
    ...
    monster = {
    	pos = {
        	...
        	a1 = {x=80, y=322, z=6, stackpos=253}, -- Blue supreme tower
        	a2 = {x=113, y=291, z=6, stackpos=253}, -- Blue top tower
        	a3 = {x=114, y=319, z=6, stackpos=253}, -- Blue middle tower
        	a4 = {x=113, y=351, z=6, stackpos=253}, -- Blue bottom tower
        	-- Monstros do time vermelho
        	b1 = {x=161, y=322, z=6, stackpos=253}, -- Red supreme tower
        	b2 = {x=131, y=291, z=6, stackpos=253}, -- Red top tower 
        	b3 = {x=129, y=323, z=6, stackpos=253}, -- Red middle tower 
        	b4 = {x=131, y=351, z=6, stackpos=253}, -- Red bottom tower
        	-- Monstros buff na jungle
       		mbuff1 = {x=124, y=306, z=6, stackpos=253}, -- Buff sorecer and paladin 1 + 2
        	mbuff2 = {x=118, y=336, z=6, stackpos=253}, -- Buff druid and knight 2 + 2
    	},
        ---------------------------------------------------
