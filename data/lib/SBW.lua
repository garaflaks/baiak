...
SBW_AREA = {{x = 333, y = 284, z = 7}, {x = 373, y = 321, z = 7}}-- AREA DO EVENTO | Canto superior esquerdo / inferior direito
SBW_WAITROOM = {{x = 348, y = 299, z = 6}, {x = 354, y = 305, z = 6}} -- AREA DE ESPERA | Canto superior esquerdo / inferior direito
SBW_TP = {x=146, y=42, z=7} -- local onde teleport sera criado (entrada de jogadores)
SBW_TPGO = {x=351, y=302, z=6} -- local onde teleport vai levar (saida de jogadores)
SBW_TPEND = {x=157, y=51, z=7} -- local onde serao teleport ao final do evento
SBW_GERADOR = {x=351, y=302, z=7} -- local onde gerador vai ficar
...
SBW_MINAMMO = 25 -- munição inicial dos jogadores
