-- CONFIG
ZE_DEFAULT_NUMBER_OF_PLAYERS = 40
ZE_ACCESS_TO_IGNORE_ARENA = 4
-- POSITIONS
ZE_blockEnterItemPosition = {x=32341, y=32213, z=7} -- onde nasce o teleport?
ZE_enterPosition = {x=534, y=544, z=7} -- onde os players nascem dentro da arena zombie?
ZE_kickPosition = {x=530, y=544, z=7} -- quando morre vai para onde?
ZE_spawnFromPosition = {x=519,y=529,z=7} -- para sumonar zombie (de)
ZE_spawnToPosition = {x=557,y=558,z=7} -- para sumonar zombie (ate)
-- ITEM IDS
