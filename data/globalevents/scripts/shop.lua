            ...
            if isPlayer(cid) == TRUE then
                ...
                if full_weight <= free_cap then
                    ...
                    if received_item == RETURNVALUE_NOERROR then
                        ...
                        doPlayerSendTextMessage(cid, SHOP_MSG_TYPE, '>> '.. add_item_name ..' << from Donate shop is waiting for you. Please make place for this item in your backpack/hands and wait about '.. SQL_interval ..' seconds to get it.')
                    end
                else
