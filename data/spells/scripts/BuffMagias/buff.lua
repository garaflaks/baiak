...
local effect2 = {13} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
local effect3 = {14} -- effect no player, caso queira apenas 1, basta remover os outros numeros.

local ml = 0 -- quantos ira aumentar o skill de ML
local skillfist = 65 -- quantos ira aumentar o skill de Fist
local skillsword = 65 -- quantos ira aumentar o skill de Sword
local skillaxe = 65 -- quantos ira aumentar o skill de Axe
local skillclub = 65 -- quantos ira aumentar o skill de Club
local skilldistance = 75 -- quantos ira aumentar o skill de Distance
local skillshield = 65 -- quantos ira aumentar o skill de Shield
...
doCreatureSay(cid, "Buff Skill", TALKTYPE_MONSTER)
