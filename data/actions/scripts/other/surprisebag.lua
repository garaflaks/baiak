local config = {
	...
	-- blue
	[6570] = {		
		{ rate = 1000, item = 12734, count = { const = 3 }},
		{ rate = 1000, item = 12734, count = { const = 4 }},
		{ rate = 1000, item = 12734, count = { const = 5 }},
		{ rate = 1000, item = 12734, count = { const = 6 }},
		{ rate = 1000, item = 12734, count = { const = 7 }}
	},
	-- red
	[6571] = {
		{ rate = 1000, item = 12734, count = { const = 5 }},
		{ rate = 1000, item = 12734, count = { const = 6 }},
		{ rate = 1000, item = 12734, count = { const = 7 }},
		{ rate = 1000, item = 12734, count = { const = 8 }},
		{ rate = 1000, item = 12734, count = { const = 9 }},
		{ rate = 1000, item = 12734, count = { const = 10 }}
	},
}
