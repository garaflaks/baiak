local bixos = {"Fire Elemental", "Dragon", "Ferumbras", "Troll"}
local positions = {{x = 400, y = 181, z = 7}, {x = 401, y = 181, z = 7}, {x = 402, y = 181, z = 7}} -- Posicao q os bixos nascem
local price = 5 -- Preco para jogar
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    addEvent(function()
	    ...
	    addEvent(doSendAnimatedText, 3000, getThingPos(cid), "KK", 25)
