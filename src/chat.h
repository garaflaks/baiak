...
class Chat
{
	public:
		...
		ChatChannel* createChannel(Player* player, uint16_t channelId/*, bool isBroadcasting = false*/);
		...
		ChannelsList getChannelList(Player* player/*, bool isBroadcasting = false*/);
